...
struct ExamplesDefaults {
    ...
    static func chartFrame(_ containerBounds: CGRect) -> CGRect {
        return CGRect(x: containerBounds.origin.x, y: containerBounds.origin.y, width: containerBounds.size.width /*- (containerBounds.size.width)*0.2*/, height: containerBounds.size.height)
    }
